...
public class Classpath {
	...
	public static String Excel_file1=Users_Home + File.separator + "Datavalues.xlsx";
	...
	public static String register_file = Users_Home +File.separator+ "resource" + File.separator + "locators" + File.separator + "opregister.properties";
	
	public static String search_file = Users_Home +File.separator+ "resource" + File.separator + "locators" + File.separator + "searchrecord.properties";
	
	public static String url_file = Users_Home +File.separator+ "resource" + File.separator + "locators" + File.separator + "browser.properties";
	
	public static String datamanage_file = Users_Home +File.separator+ "resource" + File.separator + "locators" + File.separator + "datamanagement.properties";
