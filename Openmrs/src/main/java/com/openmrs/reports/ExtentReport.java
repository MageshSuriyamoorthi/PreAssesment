...
public class ExtentReport {
	...
	static ExtentHtmlReporter reporter = new ExtentHtmlReporter("./Report/toolsqa.html");
	...
	public static void reportLog(String testname, String Failuremsg) throws IOException {
		...
		// logger.fail( "failed
		// script",MediaEntityBuilder.createScreenCaptureFromPath("C:\\Users\\Damodaran.Krishnan\\Documents\\damoo.png").build());
		extent.flush();
	}
}
